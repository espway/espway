...
size_t ICACHE_FLASH_ATTR base64_encode(const BYTE in[], BYTE out[], size_t len, int newline_flag)
{
...
size_t ICACHE_FLASH_ATTR base64_decode(const BYTE in[], BYTE out[], size_t len)
{
	BYTE ch;
