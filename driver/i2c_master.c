...
i2c_master_start(void)
{
    ...
    i2c_master_wait(I2C_MASTER_DELAY);
    i2c_master_setDC(1, 1);
    i2c_master_wait(I2C_MASTER_DELAY);	// sda 1, scl 1
    i2c_master_setDC(0, 1);
    i2c_master_wait(I2C_MASTER_DELAY);	// sda 0, scl 1
}
...
i2c_master_stop(void)
{
    ...
    i2c_master_wait(I2C_MASTER_DELAY);	// sda 0
    i2c_master_setDC(0, 1);
    i2c_master_wait(I2C_MASTER_DELAY);	// sda 0, scl 1
    i2c_master_setDC(1, 1);
    i2c_master_wait(I2C_MASTER_DELAY);	// sda 1, scl 1
...
i2c_master_setAck(uint8 level)
{
    ...
    i2c_master_wait(I2C_MASTER_DELAY);	// sda level, scl 0
...
i2c_master_readByte(void)
{
    ...
    i2c_master_wait(I2C_MASTER_DELAY);
    i2c_master_setDC(m_nLastSDA, 0);
    i2c_master_wait(I2C_MASTER_DELAY);	// sda 1, scl 0
