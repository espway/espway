...
#define COMPLEMENTARY_FILTER_ALPHA 0.0005
#define MAHONY_FILTER_KP 0.5
#define MAHONY_FILTER_KI 0.01

#define SENSOR_FUSION_MADGWICK      1
#define SENSOR_FUSION_COMPLEMENTARY 2
#define SENSOR_FUSION_MAHONY        3

#define SENSOR_FUSION_METHOD SENSOR_FUSION_MAHONY

#define ORIENTATION_STABILIZE_DURATION 6000
